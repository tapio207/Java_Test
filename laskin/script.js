...
let luvutNum = Number(insideMath);
    ...
    console.log("luvut (array) = " + luvut);
    console.log("tulos (näytölle) = " + tulos);
    console.log("vastaus (laskunTulos) = " + vastaus);
